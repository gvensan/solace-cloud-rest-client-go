...
// checks if the DatacenterResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatacenterResponse{}
...
func (o DatacenterResponse) ToMap() (map[string]interface{}, error) {
